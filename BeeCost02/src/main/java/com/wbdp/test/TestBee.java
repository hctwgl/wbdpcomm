...
public class TestBee {
	...
	public void testButton(){
		...
		String urlStr = url.replace("ACCESS_TOKEN", "mRCxGQn06u44gqLMfWfsfbfVAscWaB4jLvKLzGyN7o6qHTVvWlUqifQaP67rgT7UVdAIlS5PoZ3FwttqrwN0v1w3kAbNzvJ8erszJkn949qOCIRYbVqteLbbUpBV-rn1BPJiAIAMAU");
		...
		view3.setType("view");
		view3.setName("我的");
		view3.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6b164110550f1690&"+
				"redirect_uri=http%3A%2F%2Fwww.wisedp.com%2FBeeCost%2Ftomine&response_type=code&scope=snsapi_base&state=123#wechat_redirect");
		ViewButton view4 = new ViewButton();
		view4.setType("view");
		view4.setName("任性刷");
		view4.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6b164110550f1690&"+
				"redirect_uri=http%3A%2F%2Fwww.wisedp.com%2FBeeCost%2Ftobrush&response_type=code&scope=snsapi_base&state=123#wechat_redirect");
		Menu menu = new Menu();
