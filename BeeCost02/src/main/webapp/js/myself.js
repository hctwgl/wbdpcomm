		      	...
		      	if(data.data==="已注册"){
					...
					$.ajax({
		      		...
		      		$("#btn").on("click",function(){
		       		...
		       		$("#btn").html('立即申请');
		       		$("#btn").on("click",function(){
		       			window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6b164110550f1690&redirect_uri=http%3A%2F%2Fwww.wisedp.com%2FBeeCost%2Ftoregister&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
		       		});
		       	}
