			...
			url:"getUserContacts",
	      	...
	      	success:function(data){
		      	if(data.code===1){
		      		...
		      		$("#relation").val(mydata.relationship);
		      		$("#tel").val(mydata.phone);
		       	}else{
				...
				url:"updateUserContact",
		      	...
		      	success:function(data){
			      	...
			      	if(data.code===1){
				        ...
				        //跳回下一步界面
				        setTimeout(function(){
			      			window.location.href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6b164110550f1690&redirect_uri=http%3A%2F%2Fwww.wisedp.com%2FBeeCost%2Ftomine&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
