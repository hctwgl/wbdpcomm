...
public class CreateQRCode {
	...
	public static String createQRCode(String content,String savePath,String openid){
		...
		//content = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxb125fba57e2524e2&redirect_uri=http%3A%2F%2Fwisedp.com%2Fwisemifi%2Fwx%2Fwisemifi%2Ftobuypage&response_type=code&scope=snsapi_base&state=123#wechat_redirect";//二维码内容
		//定义二维码内容参数
		...
		try {
			...
			savePath = "http://wisedp.com/wisemifi/downimg/"+openid+"-"+timestamp+"-qr"+".png";
			return savePath;
		} catch (Exception e) {
			e.printStackTrace();
		}
